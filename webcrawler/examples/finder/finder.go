...
import (
	...
	lib "hugo.v1/webcrawler/examples/finder/internal"
	"hugo.v1/webcrawler/examples/finder/monitor"
	sched "hugo.v1/webcrawler/scheduler"
	"hugo.v1/helper/log"
)
...
func init() {
	...
	flag.StringVar(&firstURL, "first", "http://debug.cool",
		"The first URL which you want to access.")
	// flag.StringVar(&domains, "domains", "zhihu.com",
	flag.StringVar(&domains, "domains", "debug.cool",
